...
#' omitted if \code{na.rm = TRUE} or not replaced if \code{na.rm = FALSE}.
#' @seealso \code{\link{zoo}}, \code{\link{approx}},
#' \code{\link{na.contiguous}}, \code{\link{na.locf}}, \code{\link{na.omit}},
#' \code{\link{na.trim}}, \code{\link{spline}},
